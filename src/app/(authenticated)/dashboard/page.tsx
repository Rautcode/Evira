...
import { 
  ...
  CheckCircle2, Mail, Database, Activity, Server 
} from 'lucide-react';
...
export default function DashboardPage() {
  ...
  React.useEffect(() => {
    ...
    const setupWebSocket = () => {
      ...
      const wsUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL?.replace('http', 'ws')}/ws/dashboard`;
      ...
      <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-r from-blue-600 to-indigo-650 dark:from-slate-900 dark:to-slate-950 p-8 shadow-xl dark:shadow-2xl border border-white/10 dark:border-slate-800/60 transition-all duration-300">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2">
            <span className="text-[10px] bg-white/20 dark:bg-blue-900/50 text-white dark:text-blue-300 px-3 py-1 rounded-full font-bold uppercase tracking-widest">SCADA Operations Command Center</span>
            <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight">Welcome to SCADA Assistant</h1>
